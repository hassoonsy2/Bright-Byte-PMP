...
// plane imports
import type { TConfigOptions } from "@bright-byte/constants";
import { DEFAULT_FILTER_CONFIG_OPTIONS } from "@bright-byte/constants";
import type { TExternalFilter, TFilterConfig, TFilterProperty } from "@bright-byte/types";
// local imports
