...
{
  "dependencies": {
    "@bright-byte/decorators": "workspace:*"
  }
}
```
...
```typescript
import { Controller, Get, Post, BaseController } from "@bright-byte/decorators";
...
```typescript
import { Controller, WebSocket, BaseWebSocketController } from "@bright-byte/decorators";
