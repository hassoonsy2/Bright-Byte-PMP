...
// plane imports
import type { TIssueFilterPriorityObject, TIssuePriorities } from "@bright-byte/constants";
import { ISSUE_DISPLAY_FILTERS_BY_PAGE, ISSUE_PRIORITY_FILTERS, STATE_GROUPS } from "@bright-byte/constants";
import type {
  IGanttBlock,
...
import { EIssueLayoutTypes } from "@bright-byte/types";
// local imports
...
export const getComputedDisplayProperties = (
  ...
  estimate_time: displayProperties?.estimate_time ?? true,
