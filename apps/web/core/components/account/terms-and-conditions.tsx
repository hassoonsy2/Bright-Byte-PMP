...
import { EAuthModes } from "@bright-byte/constants";
...
const LEGAL_LINKS = {
  termsOfService: "https://bright-byte.example/legals/terms-and-conditions",
  privacyPolicy: "https://bright-byte.example/legals/privacy-policy",
} as const;
