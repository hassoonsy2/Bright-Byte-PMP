...
import { cn, getFileURL, getPasswordStrength, validatePersonName } from "@bright-byte/utils";
// components
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-10">
      ...
      <CommonOnboardingHeader
        ...
        description="This is how you will appear in Bright-Byte PMP."
      />
          ...
          <Controller
            ...
            render={({ field: { value, onChange, ref } }) => (
              <input
                ...
                // eslint-disable-next-line jsx-a11y/no-autofocus -- intentional UX: auto-focus the name field on first-time profile setup
                autoFocus
                className={cn(
