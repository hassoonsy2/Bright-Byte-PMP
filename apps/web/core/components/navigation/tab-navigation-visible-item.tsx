...
import { ContextMenu } from "@bright-byte/propel/context-menu";
import { SetAsDefaultIcon } from "@bright-byte/propel/icons";
import { TabNavigationItem } from "@bright-byte/propel/tab-navigation";
// local imports
