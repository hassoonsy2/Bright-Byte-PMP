...
// constants
import { SPREADSHEET_PROPERTY_DETAILS } from "@bright-byte/constants";
// i18n
import { useTranslation } from "@bright-byte/i18n";
// types
import type { IIssueDisplayFilterOptions, IIssueDisplayProperties, TIssueOrderByOptions } from "@bright-byte/types";
import { CustomMenu, Row } from "@bright-byte/ui";
...
export function HeaderColumn(props: Props) {
  ...
  // Non-sortable columns (e.g. duration, estimate_time) have no order keys — render a plain label.
