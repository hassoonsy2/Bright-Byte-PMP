...
import { NETWORK_CHOICES } from "@bright-byte/constants";
...
import type { IProject, IWorkspace } from "@bright-byte/types";
import { CustomSelect, Input, TextArea } from "@bright-byte/ui";
