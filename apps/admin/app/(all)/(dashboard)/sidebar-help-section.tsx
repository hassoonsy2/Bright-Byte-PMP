...
import { WEB_BASE_URL } from "@bright-byte/constants";
// plane internal packages
import { GithubIcon, NewTabIcon, PageIcon } from "@bright-byte/propel/icons";
  ...
  return (
    ...
    >
      <div className={`flex items-center gap-1 ${isSidebarCollapsed ? "flex-col justify-center" : "w-full"}`}>
        <Tooltip
          tooltipContent="Redirect to Bright-Byte PMP"
          position="right"
          className="ml-4"
        ...
        >
          ...
          >
            ...
            {!isSidebarCollapsed && "Redirect to Bright-Byte PMP"}
          </a>
        </Tooltip>
