...
import type { IInstance, IInstanceAdmin } from "@bright-byte/types";
import { Input, ToggleSwitch } from "@bright-byte/ui";
// components
          ...
          <div className="flex grow items-center gap-4">
            ...
            <div className="grow">
              <div className="text-13 leading-5 font-medium text-primary">
                Allow Bright-Byte PMP to send anonymous usage data to our servers
              </div>
              <div className="text-11 leading-5 font-regular text-tertiary">
                No PII is collected. This anonymized data is used to understand how Bright-Byte PMP is used and improve
                the product in line with our Telemetry Policy.
              </div>
            </div>
          </div>
