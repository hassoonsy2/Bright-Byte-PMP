...
- [x] **BRAND-10**: Email templates rebranded — `apps/api/templates/base.html` + `apps/api/templates/emails/**` (invites, magic-link, password reset, notifications) and `EMAIL_FROM`
...
| BRAND-10    | Phase 1 — User-Facing Rebrand            | Complete |
