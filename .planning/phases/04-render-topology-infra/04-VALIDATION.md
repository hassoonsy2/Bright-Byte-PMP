...
| -------- | ----- | ---- | ----------- | ---------- | --------------------------------------------------------------------- | ------------- | ----------------------------------------------------------------------------------------------------- | ----------- | ------- |
| 04-01-01 | 04-01 | 1    | DEPLOY-01   | T-04-01    | No hardcoded secrets in blueprint                                     | source        | `test -f render.yaml` and YAML/service-name assertions                                                | No          | pending |
| 04-01-02 | 04-01 | 1    | DEPLOY-02   | T-04-02    | Paid datastores; internal URLs preferred                              | source/manual | Source assertions for `type: keyvalue` and `databases:` in `render.yaml`                              | No          | pending |
| 04-02-01 | 04-02 | 1    | DEPLOY-05   | T-04-03    | Broker does not drop queued jobs silently                             | source/unit   | Source assertion for `CELERY_BROKER_URL` or `AMQP_URL`; targeted Django settings test if code changes | No          | pending |
| 04-02-02 | 04-03 | 2    | DEPLOY-03   | T-04-04    | R2 credentials are secret; browser CORS restricted to deployed origin | source/manual | Source assertions for R2 env keys in docs/examples                                                    | No          | pending |
| 04-02-03 | 04-03 | 2    | DEPLOY-04   | T-04-05    | SMTP credentials are secret; TLS/SSL mode explicit                    | source/manual | Source assertions for SMTP env keys and `test_email` instructions                                     | No          | pending |
| 04-03-01 | 04-03 | 2    | DEPLOY-06   | T-04-06    | HTTPS-only browser origins; cookies scoped intentionally              | source/manual | Source assertions for `VITE_*`, `CORS_ALLOWED_ORIGINS`, `COOKIE_DOMAIN` guidance                      | No          | pending |
| 04-04-01 | 04-04 | 3    | DEPLOY-07   | T-04-07    | Live shared instance supports only intended tenant/workspace access   | manual        | Live onboarding checklist recorded in phase summary                                                   | No          | pending |
